...
public class SearchServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Object obj = context.lookup("EmployeeJNDI");
            EmployeeSessionBeanRemote empObj = (EmployeeSessionBeanRemote) obj;
            
            List result = empObj.searchEmployee(searchValue, depID, eID);
